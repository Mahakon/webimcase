...
if (!$_GET['code']) {
     ...
     * out - $data
     */
    $token = json_decode(file_get_contents('https://oauth.vk.com/access_token?client_id=****&redirect_uri=https://lendos.me/webimcase/myWorkPlace.php&client_secret=****&code=' . $_GET['code']), true);
