            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" aria-label="Choose log">
                        ...
                        "https://oauth.vk.com/authorize?client_id=****&display=page&redirect_uri=https://lendos.me/webimcase/myWorkPlace.php&response_type=code"'>in
                        </button>
                    </div>
                </li>
            </ul>
...
<!-- Wellcome message for outlog users-->
    <div class="alert alert-success wellcome-message" role="alert" aria-label="You're not log in">
        ...
        <p class="mb-0">
            ...
            "https://oauth.vk.com/authorize?client_id=****&display=page&redirect_uri=https://lendos.me/webimcase/myWorkPlace.php&response_type=code"'
